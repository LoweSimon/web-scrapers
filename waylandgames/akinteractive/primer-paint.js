...
const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/ak-interactive?f__multi_product_type__name=Product+Type&f__multi_product_type__value=Primer&f__multi_product_type__eq=47854"
...
const main = async () => {
    ...
    fs.writeFile('../waylandgames-paint-data/akinteractive/primer-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
