...
async function scrape() {
    try {
        ...
        const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/ak-interactive?p=2&f__brand__name=Brand&f__brand__value=3rd+Generation&f__brand__eq=53207"
        ...
        fs.writeFile('../waylandgames-paint-data/akinteractive/acrylic-paint.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
