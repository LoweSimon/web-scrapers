...
async function scrape() {
    try {
        ...
        const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/army-painter-warpaints/sprays"
        ...
        fs.writeFile('../waylandgames-paint-data/armypainter/spray-paint.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
