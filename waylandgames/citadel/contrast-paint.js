...
const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/citadel-paints/citadel-contrast"
...
const main = async () => {
    ...
    fs.writeFile('../waylandgames-paint-data/citadel/citadel-contrast-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
