...
async function getShadePaint() {
    try {
        ...
        const response = await fetch(`${base_url}painting-modelling/paints-sprays-primers/citadel-paints/citadel-shade?s__name=ASC`);
        ...
        fs.writeFile("../waylandgames-paint-data/citadel/citadel-shade-paint.json", itemsString, function(err, result) {
