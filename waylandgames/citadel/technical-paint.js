...
async function getTechnicalPaint() {
    try {
        ...
        const response = await fetch(`${base_url}painting-modelling/paints-sprays-primers/citadel-paints/citadel-technical?s__name=ASC`);
        ...
        fs.writeFile("../waylandgames-paint-data/citadel/citadel-technical-paint.json", itemsString, function(err, result) {
