...
async function scrape() {
    try {
        ...
        const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/vallejo-paints/game-color"
        ...
        fs.writeFile('../waylandgames-paint-data/vallejo/game-color.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
