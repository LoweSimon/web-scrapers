...
const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/vallejo-paints/xpress-color"
...
const main = async () => {
    ...
    fs.writeFile('../waylandgames-paint-data/vallejo/xpress-color.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
