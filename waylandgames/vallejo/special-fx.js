...
const full_url = "https://www.waylandgames.co.uk/painting-modelling/paints-sprays-primers/vallejo-paints/special-fx"
...
const main = async () => {
    ...
    fs.writeFile('../waylandgames-paint-data/vallejo/special-fx.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
