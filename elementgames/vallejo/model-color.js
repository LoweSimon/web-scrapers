...
async function getModelColor()   {
    try {
        const base_url = "https://elementgames.co.uk"

        // fetching data from url and store the response
        const response = await fetch(`${base_url}/paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/model-color/model-color-paints`);
