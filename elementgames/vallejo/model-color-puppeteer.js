...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/model-color/model-color-paints"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/vallejo/model-color-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
