...
async function getSurfacePrimer()   {
    try {
        const base_url = "https://elementgames.co.uk/"

        // fetching data from url and store the response
        const response = await fetch(`${base_url}paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/surface-primers`);
        ...
        fs.writeFile("../element-games-paint-data/vallejo/vallejo-surface-primer-paint.json", itemsString, function(err, result)  {
