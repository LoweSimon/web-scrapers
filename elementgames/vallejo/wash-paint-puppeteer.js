...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/washes"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/vallejo/wash-paint-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
