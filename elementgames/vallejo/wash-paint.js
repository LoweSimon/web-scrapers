...
async function getWashPaint()   {
    try {
        ...
        const response = await fetch(`${base_url}paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/washes`);
        ...
        fs.writeFile("../element-games-paint-data/vallejo/vallejo-wash-paint.json", itemsString, function(err, result)  {
