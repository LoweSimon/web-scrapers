...
async function getXpressPaint()   {
    try {

        let base_url = "https://elementgames.co.uk/";

        // fetching data from url and store the response
        const response = await fetch(`${base_url}paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/xpress-color`);
        ...
        fs.writeFile("../element-games-paint-data/vallejo/vallejo-xpress-paint.json", itemsString, function(err, result)  {
