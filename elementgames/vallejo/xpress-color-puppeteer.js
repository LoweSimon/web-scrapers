...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/xpress-color"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/vallejo/xpress-color-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
