...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/vallejo-paints/vallejo-game-air/paints"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/vallejo/vallejo-game-air-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
