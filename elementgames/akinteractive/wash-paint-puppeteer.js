...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-hobby-and-scenery-by-manufacturer/ak-interactive/AKWASH"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/akinteractive/akinteractive-wash-paint-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
