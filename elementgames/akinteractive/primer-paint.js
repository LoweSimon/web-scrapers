...
async function getPrimerPaint()   {
    try {
        ...
        const response = await fetch(`${base_url}paints-hobby-and-scenery/paints-hobby-and-scenery-by-manufacturer/ak-interactive/primers`);
        ...
        fs.writeFile("../element-games-paint-data/akinteractive/akinteractive-primer-paint.json", itemsString, function(err, result)  {
