...
async function getWashPaint()   {
    try {

        let base_url = "https://elementgames.co.uk/";

        // fetching data from url and store the response
        const response = await fetch(`${base_url}paints-hobby-and-scenery/paints-hobby-and-scenery-by-manufacturer/ak-interactive/AKWASH`);
        ...
        fs.writeFile("../element-games-paint-data/akinteractive/akinteractive-wash-paint.json", itemsString, function(err, result)  {
