...
async function getElementVallejoPaint()   {
    try {
        ...
        const response = await fetch('https://elementgames.co.uk/paints-hobby-and-scenery/paints-hobby-and-scenery-by-manufacturer/ak-interactive/ak-acrylics');
        ...
        fs.writeFile("../element-games-paint-data/akinteractive/elementgames-akinteractive-acrylic-paint.json", itemsString, function(err, result)  {
