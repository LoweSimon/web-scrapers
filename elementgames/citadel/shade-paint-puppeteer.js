...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/citadel-games-workshop-paints/citadel-shade"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/citadel/shade-paint-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
