...
async function getElementCitadelPaint()   {
    try {
        ...
        const response = await fetch('https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/citadel-games-workshop-paints/citadel-technical');
        ...
        fs.writeFile("../element-games-paint-data/citadel/citadel-technical-paint.json", itemsString, function(err, result)  {
