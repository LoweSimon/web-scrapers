...
async function getElementCitadelPaint()   {
    try {
        ...
        const response = await fetch(`${base_url}https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/citadel-games-workshop-paints/citadel-layer-1`);
        ...
        fs.writeFile("../element-games-paint-data/citadel/citadel-layer-paint.json", itemsString, function(err, result)  {
