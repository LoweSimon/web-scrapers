...
async function getElementCitadelPaint()   {
    try {
        ...
        const response = await fetch('https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/citadel-games-workshop-paints/citadel-contrast');
        ...
        fs.writeFile("../element-games-paint-data/citadel/citadel-contrast-paint.json", itemsString, function(err, result)  {
