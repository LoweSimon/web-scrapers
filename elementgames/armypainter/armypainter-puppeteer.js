...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/army-painter-warpaints"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/armypainter/armypainter-puppeteer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
