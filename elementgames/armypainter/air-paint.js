...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/warpaint-air-AP"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/armypainter/air-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
