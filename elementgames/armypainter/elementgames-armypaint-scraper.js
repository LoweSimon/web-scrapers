...
async function getElementArmyPainterPaint()   {
    try {
        // fetching data from url and store the response
        const response = await fetch('https://elementgames.co.uk/paints-hobby-and-scenery/paints-washes-etc/army-painter-warpaints');
