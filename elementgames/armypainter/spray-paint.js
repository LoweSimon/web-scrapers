...
const full_url = "https://elementgames.co.uk/paints-hobby-and-scenery/paints-hobby-and-scenery-by-manufacturer/the-army-painter/spray-paints-primers/the-army-painter-sprays"
...
const main = async () => {
    ...
    fs.writeFile('../element-games-paint-data/armypainter/spray-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
