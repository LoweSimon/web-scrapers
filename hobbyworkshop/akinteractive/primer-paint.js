...
const full_url = "https://www.hobbyworkshop.co.uk/paint/ak-interactive/primers.html"
...
const main = async () => {
    ...
    fs.writeFile('../paint-data/akinteractive/ak-primer-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
