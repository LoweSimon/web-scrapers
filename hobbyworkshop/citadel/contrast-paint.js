...
async function scrape() {
    try {
        ...
        const full_url = "https://www.hobbyworkshop.co.uk/paint/citadel/contrast.html"
        ...
        fs.writeFile('../paint-data/citadel/contrast-paint.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
