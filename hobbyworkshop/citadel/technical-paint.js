...
const full_url = "https://www.hobbyworkshop.co.uk/paint/citadel/technical.html"
...
const main = async () => {
    ...
    fs.writeFile('../paint-data/citadel/technical-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
