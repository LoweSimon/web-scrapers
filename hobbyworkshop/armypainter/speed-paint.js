...
const full_url = "https://www.hobbyworkshop.co.uk/paint/army-painter/speed-paint.html"
...
const main = async () => {
    ...
    fs.writeFile('../paint-data/armypainter/speed-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
