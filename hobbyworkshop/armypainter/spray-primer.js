...
const full_url = "https://www.hobbyworkshop.co.uk/paint/army-painter/warpaint.html?citadel_paint_type=1536"
...
const main = async () => {
    ...
    fs.writeFile('../paint-data/armypainter/spray-primer.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
