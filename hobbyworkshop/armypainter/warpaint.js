...
async function scrape() {
    try {
        ...
        const full_url = "https://www.hobbyworkshop.co.uk/paint/army-painter/warpaint.html?citadel_paint_type=1534"
        ...
        fs.writeFile('../paint-data/armypainter/warpaint.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
