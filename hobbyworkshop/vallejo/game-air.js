...
async function scrape() {
    try {
        ...
        const full_url = "https://www.hobbyworkshop.co.uk/paint/vallejo/vallejo-game-air.html"
        ...
        fs.writeFile('../paint-data/vallejo/game-air.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
