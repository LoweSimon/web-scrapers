...
async function scrape() {
    try {
        ...
        const full_url = "https://www.hobbyworkshop.co.uk/paint/vallejo/vallejo-primer.html"
        ...
        fs.writeFile('../paint-data/vallejo/primer.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
