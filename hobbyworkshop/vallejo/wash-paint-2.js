...
const full_url = "https://www.hobbyworkshop.co.uk/paint/vallejo/vallejo-washes.html"
...
const main = async () => {
    ...
    fs.appendFile('../paint-data/vallejo/wash-paint.json', JSON.stringify(paintData, null, 2), (err) => {
        if (err) throw err
