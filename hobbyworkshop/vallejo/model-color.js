...
async function scrape() {
    try {
        ...
        const full_url = "https://www.hobbyworkshop.co.uk/paint/vallejo/vallejo-model-color.html"
        ...
        fs.writeFile('../paint-data/vallejo/model-color.json', JSON.stringify(data, null, 2), (err) => {
            if (err) throw err
